    ...
    render() {
        ...
        let prev1 = ( this.state.photoUrls != undefined  && this.state.photoUrls.length != 0) ? 
            this.state.photoUrls.map((photoUrl, i) => (
                <div>
                    {/* <p>x</p> */}
                    <img key={i} id={`form-photo-${i}`} className="form-photos" src={photoUrl} alt="preview-photo"></img>
                </div>
                )) : null

        let prev2 = ( this.state.photoFiles != undefined && this.state.photoFiles.length != 0) ? 
            this.state.photoFiles.map((photo, i) => (
            <img key={i} id={`form-photo-${i}`} className="form-photos" src={photo} alt="preview-photo"></img>
                )) : null

        let preview = <div> {prev1} {prev2} </div>
